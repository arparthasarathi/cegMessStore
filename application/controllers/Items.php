<?php
   ...
   class Items extends CI_Controller {
      ...
      */
      ...
      public function return_item($data="")
      {
         ...
         redirect('auth/login','refresh');
            ...
            if(isset($_POST['submit'])){
               ...
               $data['issuedDate'] = date('Y-m-d',strtotime($this->input->post('issuedDate')));
      ...
      public function getMessConsumptionForDate($messName = null,$date=null)
      {
      ...
      public function edit_row_form()
      {
         ...
         public function update_issued_items($data="")
         {
            ...
            redirect('auth/login','refresh');
               ...
               redirect('mess/mess_consumption',$data);
               else
               {
                  $data['error'] = $return;
                  redirect('mess/mess_consumption',$data);
